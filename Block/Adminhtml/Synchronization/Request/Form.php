...
namespace Attlaz\Base\Block\Adminhtml\Synchronization\Request;
...
//        var_dump($this->getUrl('*/*/request'));

        $fieldset = $form->addFieldset('base_fieldset', [
            'legend' => __('Request catalog synchronisation'),
            'class'  => 'fieldset-wide',
        ]);

        $fieldset->addField('external_ids', 'editor', [
            'name'     => 'external_ids',
...
//        ]);
        ...
        $fieldset->addField('skip_images', 'select', [
            'label'    => __('Skip images'),
            'title'    => __('Skip images'),
            'name'     => 'skip_images',
            'required' => true,
            'options'  => [
                'yes' => __('Yes (No media will be synchronized)'),
                'no'  => __('No (Media will be synchronized)'),
...
//                                               ->getId(),
//            ]);
//            $model->setStoreId($this->_storeManager->getStore(true)
//                                                   ->getId());
//        }
